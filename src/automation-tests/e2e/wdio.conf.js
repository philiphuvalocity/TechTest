require('dotenv').config({ path: './src/automation-tests/e2e/.env' });

const envUrl = require('./config/sandbox-sites');
...
exports.config = {
  ...
  reporters: [
    ['junit', {
      outputDir: './src/automation-tests/junit',
